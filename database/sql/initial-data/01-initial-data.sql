...
INSERT INTO core.users(id, phone, email, first_name, last_name, password, enabled) VALUES
  (1, '+996772136130', 'user@domain.com', 'Александр', 'Иванов', '$2a$10$h7MeivRcGNAnDS4p4buFuuYIbruyKcmT7DbKXwDagwNyMnvnuhXLS', true);
INSERT INTO core.users(id, phone, email, first_name, last_name, password, enabled) VALUES
  (2, '+996705136130', 'admin@domain.com', 'Роман', 'Александров', '$2a$10$h7MeivRcGNAnDS4p4buFuuYIbruyKcmT7DbKXwDagwNyMnvnuhXLS', true);
